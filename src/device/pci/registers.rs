/// A very simple register implementation supporting RW1C bits.
///
...
impl SimpleRegister {
    ...
    /// - bitmask_rw1c: a bitmask indicating which bits are RW1C.
    pub const fn new(initial_value: u64, bitmask_rw1c: u64) -> Self {
        Self {
            value: initial_value,
            bitmask_rw1c,
        }
