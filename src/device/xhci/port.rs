...
use crate::{
    device::{
        pci::{
            constants::xhci::{operational::portsc, MAX_PORTS, NUM_USB3_PORTS},
            trb::EventTrb,
        },
        xhci::real_device::{CompleteRealDevice, Identifier, RealDevice, Speed},
    },
...
impl<RD: RealDevice, ID: Identifier> PortArray<RD, ID> {
    pub fn new(event_sender: mpsc::Sender<EventTrb>, async_runtime: runtime::Handle) -> Self {
