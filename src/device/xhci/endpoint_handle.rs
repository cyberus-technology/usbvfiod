...
mod tests {
    ...
    use crate::device::{bus::testutils::TestBusDevice, xhci::trb::RawTrbBuilder};
    ...
    #[tokio::test]
    async fn submitting_a_out_of_order_and_unfinished_sequence_does_not_prevent_a_following_valid_sequence_of_trb(
    ) {
        let (mut event_receiver, mut control_endpoint) = init_control_endpoint_handle_test();
    ...
    // dummy for bulk in real endpoint returning the requested length array with value 42
    #[derive(Debug)]
    ...
    #[tokio::test]
    async fn submit_a_multi_trb_bulk_in_transfer_with_event_data() {
        const SLOT_ID: u8 = 1;
        const ENDPOINT_ID: u8 = 1;
    ...
    #[tokio::test]
    async fn submit_a_multi_trb_bulk_out_transfer_with_event_data() {
        const SLOT_ID: u8 = 1;
        const ENDPOINT_ID: u8 = 1;
